...
model = YOLO(
    "/home/tipriest/Documents/algorithm_practice/pylibs/ultralytics/0127_best.onnx",
    task="detect",
)

# reference https://docs.ultralytics.com/modes/predict/ for more information.
model.predict(
    source="/home/tipriest/Documents/algorithm_practice/pylibs/ultralytics/3c4b620dbcb7a96fb7cb2191eebca1f1.mp4",  # (str, optional) source directory for images or videos
