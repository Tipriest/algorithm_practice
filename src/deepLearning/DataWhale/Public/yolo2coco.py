...
parser.add_argument('--root_dir', default='/home/tipriest/data/seg_risky/datasetCOCO/valid',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str, default='valid_anno.json', help="if not split the dataset, give a path to a json file")
...
def yolo2coco(arg):
    ...
    # indexes = ["0a1c6fb0c733b7fd532bf6ec7490c55a.jpg"]
    ...
    for k, index in enumerate(tqdm(indexes)):
        ...
        with open(os.path.join(originLabelsDir, txtFile), 'r') as fr:
            ...
            for label in labelList:
                ...
                H, W, _ = im.shape
                x1 = float(min(even_label))* W
                y1 = float(min(odd_label)) * H
                x2 = float(max(even_label))* W
                y2 = float(max(odd_label)) * H
